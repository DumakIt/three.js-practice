...
const scene1 = new CreateScene({ renderer, placeholder: ".canvas-placeholder.a" });
scene1.set(() => {
...
const scene2 = new CreateScene({ renderer, placeholder: ".canvas-placeholder.b" });
scene2.set(() => {
  const light = new THREE.DirectionalLight("white", 1);
  light.position.set(-1, 2, 3);
...
const scene3 = new CreateScene({ renderer, placeholder: ".canvas-placeholder.c" });
scene3.set(() => {
  const light = new THREE.DirectionalLight("white", 1);
  light.position.set(-1, 2, 3);
  ...
  gltfLoader.load("./models//free_cyberpunk_hovercar.glb", (glb) => {
